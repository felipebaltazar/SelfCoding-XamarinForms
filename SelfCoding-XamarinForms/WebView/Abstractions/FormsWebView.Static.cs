...
namespace Xam.Plugin.WebView.Abstractions
{
    ...
    {
        private static readonly WeakEventManager<string> _weakEventManager = new WeakEventManager<string>();

        public static event EventHandler<string> CallbackAdded
        {
            add => _weakEventManager.AddEventHandler(value, nameof(CallbackAdded));
            remove => _weakEventManager.RemoveEventHandler(value, nameof(CallbackAdded));
        }
        ...
        /// <summary>
        /// A bindable property for the ContentLoaddedCommand
        /// </summary>
        public static readonly BindableProperty OnContentLoadedCommandProperty = BindableProperty.Create(nameof(OnContentLoadedCommand), typeof(ICommand), typeof(FormsWebView));

        /// <summary>
        /// A bindable property for the RenderMode property.
        /// </summary>
        public static readonly BindableProperty RenderModeProperty = BindableProperty.Create(nameof(RenderMode), typeof(WebViewRenderMode), typeof(FormsWebView), WebViewRenderMode.Html);

        /// <summary>
        /// A bindable property for the CurrentUrl property.
        /// </summary>
        ...
        public static void AddGlobalCallback(string functionName, Action<string> action)
        {
            ...
            _weakEventManager.RaiseEvent(default(object), functionName, nameof(CallbackAdded));
        }
